...
- On pages with footer metadata (for example `<br>` and the trailing categories block), place `[toc]` immediately prior to that footer block.
- On pages without a footer block, place `[toc]` as the final content line of the page.
